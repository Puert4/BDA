...
public class DomicilioDAO implements IDomicilioDAO {
    ...
    @Override
    public DomicilioCliente agregar(DomicilioNuevoDTO domicilioNuevoDTO, int id_cliente) throws PersistenciaException {
        String sentenciaSQL = """
        ...
        try (Connection conexion = this.conexionBD.obtenerConexion(); PreparedStatement comando = conexion.prepareStatement(sentenciaSQL, Statement.RETURN_GENERATED_KEYS);) {
            ...
            comando.setInt(3, domicilioNuevoDTO.getNumero_exterior());
            comando.setInt(4, domicilioNuevoDTO.getNumero_interior());
